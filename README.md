...
| 23 | UX: server-side auth check, loading overlay, XSS fix | [#23](https://github.com/DiegoSVilla/qwelio/issues/23) ✅ |
| 25 | UX: dashboard layout with sticky chat sidebar | [#25](https://github.com/DiegoSVilla/qwelio/issues/25) ✅ |
